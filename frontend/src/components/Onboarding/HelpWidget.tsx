...
export const HelpWidget = () => {
 ...
 className="mb-4 w-80 bg-surface-high border border-outline/20 rounded-none shadow-2xl overflow-hidden"
 >
 ...
 <div className="p-4">
 <div className="flex items-center gap-2 bg-surface-highest rounded-none px-4 py-2 mb-4">
 ...
 {article.title}
 {isRelevant && <span className="text-[10px] px-2 py-1 rounded-none bg-primary/10 text-primary">Relevant</span>}
 </span>
 <span className="text-secondaryText text-xs group-open:rotate-180 ">▼</span>
 </summary>
 ...
 className="w-12 h-12 rounded-none bg-primary text-black shadow-pixel hover:bg-primary/90 flex items-center justify-center"
 >
