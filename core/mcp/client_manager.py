...
class MCPClientManager:
    ...
    Usage:
        ...
        await manager.connect_stdio("filesystem", "python", ["-m", "core.mcp.servers.filesystem"])
    ...
    async def start_system_servers(self) -> None:
        ...
        servers = [
            ("filesystem", sys.executable, ["-m", "core.mcp.servers.filesystem"]),
            ("shell", sys.executable, ["-m", "core.mcp.servers.shell"]),
            ("cloud_api", sys.executable, ["-m", "core.mcp.servers.cloud_api"]),
            ("desktop", sys.executable, ["-m", "core.mcp.servers.desktop"]),
            ("browser_env", sys.executable, ["-m", "core.mcp.servers.browser"]),
            ("document", sys.executable, ["-m", "core.mcp.servers.document"]),
            ("code_executor", sys.executable, ["-m", "core.mcp.servers.code"]),
        ]
