          ...
          {toasts.map((toast) => {
            ...
            return (
              <motion.div
                ...
                className={`pointer-events-auto min-w-[280px] max-w-sm px-4 py-3 rounded-lg border ${config.borderColor} ${config.bgColor} backdrop-blur-sm shadow-lg flex items-start gap-3`}
              >
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="text-secondaryText hover:text-primaryText transition-colors shrink-0"
