...
from supervisor.proto import worker_pb2 as worker__pb2
...
class WorkerExecutorStub(object):
...
class WorkerExecutorServicer(object):
    """Task execution service
    """
...
def add_WorkerExecutorServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('worker.WorkerExecutor', rpc_method_handlers)
