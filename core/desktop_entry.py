...
Usage:
    # Run directly
    python -m core.desktop_entry
    
    # Or import and use
    from core.desktop_entry import main
    asyncio.run(main())
...
# - AGENTOS_RUNTIME_MODE is checked by core.runtime.mode
...
class DesktopRuntime:
    ...
    async def initialize(self) -> BootstrapContext:
        ...
        from core.desktop_native.local_tracer import local_tracer
        await local_tracer._ensure_table()

        from core.desktop_native.local_alerts import local_alerts
        await local_alerts.initialize()

        from core.desktop_native.memory_hierarchy import memory_hierarchy
