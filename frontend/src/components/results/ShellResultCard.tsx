...
export const ShellResultCard: React.FC<Props> = ({ visibility, output }) => {
 ...
 return (
 <div className="rounded-none border border-gray-200 bg-gray-50 p-4 shadow-sm">
 ...
 {output && (
 <pre className="bg-black text-green-400 rounded-none px-4 py-2 text-xs overflow-auto max-h-48 border border-gray-700">
 {output}
 </pre>
 )}
 </div>
