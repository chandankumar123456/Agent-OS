...
use windows::Win32::UI::WindowsAndMessaging::{
    EnumWindows, GetWindowRect, GetWindowTextW, IsWindowVisible, SetCursorPos, ShowWindow,
    SetForegroundWindow, SW_RESTORE,
};
...
impl WindowAutomation {
    ...
    pub fn click(&self, x: i32, y: i32) -> bool {
        unsafe {
            ...
            sent as usize == inputs.len() // Check all inputs were sent
        }
    }
