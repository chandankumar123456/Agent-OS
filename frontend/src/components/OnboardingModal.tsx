...
const OnboardingModal: React.FC<OnboardingModalProps> = ({ onClose }) => {
 ...
 <div className="w-24 h-24 rounded-none bg-primary/10 flex items-center justify-center">
 ...
 whileTap={{ scale: 0.96 }}
 className="flex items-center gap-3 p-4 bg-surface-highest rounded-none border border-outline/10 hover:border-primary/30 group text-left"
 >
 <div className="w-10 h-10 rounded-none bg-primary/10 flex items-center justify-center group-hover:bg-primary/20 ">
 ...
 onClick={handleSkip}
 whileTap={{ scale: 0.96 }}
 className="text-xs text-secondaryText hover:text-primaryText flex items-center gap-1 mt-2"
 >
 ...
 className="w-full max-w-lg bg-surface-high border border-outline/20 rounded-none shadow-2xl overflow-hidden"
 >
 {/* Header */}
